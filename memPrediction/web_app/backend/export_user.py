...
def get_user_job(data: Dict[str, str]):
    ...
    job_data.to_csv(f'{user}_from_{start_date}_to_{end_date}.csv', index=False)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Get user job data.')
    ...
    get_user_job({'user': args.user, 'start_date': args.start_date, 'end_date': args.end_date})
